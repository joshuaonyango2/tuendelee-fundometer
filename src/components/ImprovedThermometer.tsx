      ...
      <div className="flex flex-col lg:flex-row items-center lg:items-start justify-center gap-8 lg:gap-24">
        ...
        <div className="relative flex-shrink-0">
          <div className="relative w-24 h-[600px]">
            ...
            {paidHeight > 0 && (
              <div 
                className="absolute -left-28 w-32 flex items-center justify-end transition-all duration-1000 ease-out translate-y-2"
            ...
            {unpaidAmountUSD > 0 && totalHeight > 0 && (
              <div 
                className="absolute -right-28 w-32 flex items-center transition-all duration-1000 ease-out translate-y-2"
